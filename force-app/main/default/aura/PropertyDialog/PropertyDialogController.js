...
if (recId) {
        ...
        "Property__c",
            ...
            $A.getCallback(function(){
              var rec = component.get("v.propertyRecord");
                ...
                if(error || (rec===null)){
                    console.log("Error in initilizting Record" + error);
                    return;
                }
            })
    ...
    saveRecord : function(component, event, helper) {
        ...
        component.set("v.proprtyRecord.Beds__c", propBeds);
       ...
       console.log(result.state);
            ...
            if(result.state === "SUCCESS"){
              ...
              helper.navigateTo(component, recId);
                ...
                resultsToast.setParams({
                    "title":"Error",
                    "message":"there was an error saving the record:" + Json.stringfy(result.error)
                    
                });
                resultsToast.fire();
                
            }else{
                console.log('Unkown problem, state :' +result.state +', error:'+JSON.stringify(result.error));
            }
